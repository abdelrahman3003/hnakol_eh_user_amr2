...
class RouteHelper {
  ...
  static String getChatRoute({required NotificationBodyModel? notificationBody, User? user, int? conversationID, int? index, int? conversationId}) {
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: splash, page: () {
      ...
      return SplashScreen(body: data, linkBody: linkData);
    }),
