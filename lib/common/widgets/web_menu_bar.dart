                  ...
                  for (int index = 0; index < AppConstants.joinDropdown.length; index++) {
                    if (index != 0) {
                      joinUsList.add(DropdownItem<int>(value: index, child: Padding(
                        ...
                        child: Text(AppConstants.joinDropdown[index].tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, fontWeight: FontWeight.w100, color: isDarkMode ? Colors.white : Colors.black)),
                      )));
                    }
                  }
                  return Row(children: [
                    ...
                    ConstrainedBox(
                      ...
                      child: CustomDropdown<int>(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(CupertinoIcons.person, color: isDarkMode ? Colors.white : Colors.black, size: 16,),
                            const SizedBox(width: Dimensions.paddingSizeSmall),
                            Text(AppConstants.joinDropdown[0].tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, fontWeight: FontWeight.w100, color: isDarkMode ? Colors.white : Colors.black)),
                          ],
                        ),
                      ),
                    ),
        ...
        Container(
          ...
          child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Row(children: [
            InkWell(
              ...
              child: Row(children: [
                Image.asset(isDarkMode ? Images.logoDark : Images.logo, height: 30, width: 40),
                if (!isDarkMode) ...[
                Image.asset(
                  Images.logoName,
                  width: 120,
            ...
            GetBuilder<AuthController>(builder: (authController) {
              return InkWell(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    Icon(authController.isLoggedIn() ? CupertinoIcons.person_crop_square : CupertinoIcons.lock, size: 18, color: isDarkMode ? Colors.white : Colors.black),
                    const SizedBox(width: Dimensions.paddingSizeSmall),
