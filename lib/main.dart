...
Future<void> main() async {
  ...
  //   url: 'https://kikbuboikuyxomakseqe.supabase.co',
  //   anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imtpa2J1Ym9pa3V5eG9tYWtzZXFlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzMxNTExNTYsImV4cCI6MjA0ODcyNzE1Nn0.uC49eXLjjIF8ewtn6KHLTl_nKFSd9xvl7l0xp_H_40w',
  // );
  WidgetsFlutterBinding.ensureInitialized();
  await SharedPrefs().init();
  await Firebase.initializeApp(
      options: const FirebaseOptions(
    apiKey: 'AIzaSyD7D524g0bCnCChDsvT4KOn_G1nGv9jDQ8',
    appId: '1:303325207155:android:4d97e3823e3d1f696ee806',
    messagingSenderId: '303325207155',
    projectId: 'hanakol-eah-71378',
  ));
  ...
  // Handle initial message if the app was launched from a notification
  RemoteMessage? initialMessage =
      await FirebaseMessaging.instance.getInitialMessage();
  NotificationBodyModel? body;
  if (initialMessage != null) {
    body = NotificationHelper.convertNotification(initialMessage.data);
  }
