        ...
        return GetBuilder<CartController>(
          builder: (cartController) {
            ...
            if (restaurantController.restaurant != null &&
                ...
                restaurantController.restaurant!.schedules != null) {
                                                                        ...
                                                                        WebConstrainedBox(
                                                                          ...
                                                                          child: Column(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                if (sharedPrefs.getPhone() == '') const SizedBox(height: Dimensions.paddingSizeSmall),

                                                                                if (sharedPrefs.getPhone() == '')
                                                                                  Padding(
                                                                                    padding: EdgeInsets.symmetric(horizontal: ResponsiveHelper.isDesktop(context) ? 0 : Dimensions.fontSizeDefault),
                                                                                    child: CustomTextFieldWidget(
                                                                                      ...
                                                                                      countryDialCode: _countryDialCode != null ? CountryCode.fromCountryCode(Get.find<SplashController>().configModel!.country!).code : Get.find<LocalizationController>().locale.countryCode,
                                                                                      labelText: 'phone'.tr,
                                                                                      required: true,
                                  ...
                                  onTap: () async {
                                    ...
                                    if (sharedPrefs.getPhone() == '' &&
                                      ...
                                      if (!phoneValid.isValid) {
                                        ...
                                        if (!cartController.cartList.first
